...
// RETURNS:    None.
//
void CLogEvent::AddColumnEntry( const UINT p_uColNum, const char *p_pszString )
{
   MEMBERASSERT();
   ...
   {
      TRACE("The table row size has been exceeded in AddColumnEntry(string).\n");
      return;
   }

   strncpy(&(m_szRowText[uIndex]), p_pszString, m_uColWidth[uColInx]);
...
// RETURNS:    None.
//
void CLogEvent::AddColumnEntry( const UINT p_uColNum, const int p_nEntry )
{
   MEMBERASSERT();
   ...
   if (uIndex + m_uColWidth[uColInx] > c_uMaxRowLength)
   {
      TRACE("The table row size has been exceeded in AddColumnEntry(int).\n");
      return;
   }
...
// RETURNS:    None.
//
void CLogEvent::AddColumnEntry( const UINT p_uColNum, const float p_fEntry )
{
   MEMBERASSERT();
   ...
   if (uIndex + m_uColWidth[uColInx] > c_uMaxRowLength)
   {
      TRACE("The table row size has been exceeded in AddColumnEntry(float).\n");
      return;
   }

   AXU_sprintf(&(m_szRowText[uIndex]), m_uColWidth[uColInx], c_szFloat, p_fEntry);
...
// RETURNS:    None.
//
void CLogEvent::AddColumnEntry( const UINT p_uColNum, const double p_dEntry )
{
   MEMBERASSERT();
   ...
   if (uIndex + m_uColWidth[uColInx] > c_uMaxRowLength)
   {
      TRACE("The table row size has been exceeded in AddColumnEntry(double).\n");
      return;
   }

   AXU_sprintf(&(m_szRowText[uIndex]), m_uColWidth[uColInx], c_szFloat, p_dEntry);
