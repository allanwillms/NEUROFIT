...
public:
   ...
   void AppendRow();
   void AddColumnEntry( const UINT p_uColNum, const char *p_pszString );
   void AddColumnEntry( const UINT p_uColNum, const int p_nEntry );
   void AddColumnEntry( const UINT p_uColNum, const float p_fEntry );
   void AddColumnEntry( const UINT p_uColNum, const double p_dEntry );
   void CloseTable();
