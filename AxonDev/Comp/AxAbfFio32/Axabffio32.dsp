...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winmm.lib version.lib /nologo /subsystem:windows /dll /machine:I386 /nodefaultlib:"LIBCMTD"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winmm.lib version.lib /nologo /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"LIBCMT"
# Begin Special Build Tool
OutDir=.\.\Debug
TargetName=Axabffio32
SOURCE=$(InputPath)
