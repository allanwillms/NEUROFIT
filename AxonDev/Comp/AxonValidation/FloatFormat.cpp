                                        ...
                                        int *pnError )
{
   ...
   double   dTmpNum;
   int      nConversion, nRetVal, nRetVal2, nRetVal3;
...
{  
   ...
   int    nDecPos, nSign, nSigDig, nTemp;
   UINT   uToLeft;
   double dToLeft, dScale, dAbsNum = fabs(dNumber);
